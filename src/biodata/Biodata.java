...
class GUI extends JFrame {
    ...
    JLabel lnama = new JLabel(" AMALIA CAHYA ");
    JLabel lttl = new JLabel(" Klaten, 10 Mar 2001 ");
   ...
   public GUI() {
	...
	setSize(255,620);
        ...
        labelGambar = new JLabel (new ImageIcon (getClass().getResource(("gambar.jpeg"))));
